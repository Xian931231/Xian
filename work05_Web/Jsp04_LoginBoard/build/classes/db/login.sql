...
VALUES(MYNOSEQ.NEXTVAL,'ADMIN','ADMIN1234','관리자','관리시 관리구 관리동','010-1237-5687',
	   'ADMIN@NAVER.COM','Y','ADMIN');	
	   
INSERT INTO MYMEMBER
VALUES(MYNOSEQ.NEXTVAL,'USER1','USER1','사용자1','사용시 사용구 사용동','010-2347-4487',
	   'USER1@NAVER.COM','Y','USER');		   
